...
python -m unittest discover -s tests -v      # 259 tests (engine, templates, hedge learner, walk-forward, robustness, selection, data, live signals, market sessions, both entry points)
